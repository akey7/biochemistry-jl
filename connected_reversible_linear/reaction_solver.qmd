...
# @variable(model, -1.0 <= v1 <= 1.0)
# @variable(model, -1.0 <= v2 <= 1.0)
# @variable(model, -1.0 <= v3 <= 1.0)
# @variable(model, -1.0 <= v4 <= 1.0)
# @variable(model, -1.0 <= v5 <= 1.0)

# Define flux variables and their constraints
@variable(model, 0.0 <= v1 <= 1.0)
@variable(model, 0.0 <= v2 <= 1.0)
@variable(model, 0.0 <= v3 <= 1.0)
@variable(model, 1e-3 <= v4 <= 1.0)
@variable(model, 1e-3 <= v5 <= 1.0)
