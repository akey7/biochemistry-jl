...
@variable(model, v1 >= 1e-5)
@variable(model, v2 >= 1e-5)
@variable(model, v3 >= 1e-5)
@variable(model, v4 >= 1e-5)
@variable(model, v5 >= 1e-5)
...
@constraint(model, v2 >= 1)
@constraint(model, v2 >= 1)
@constraint(model, v3 >= 1)
@constraint(model, v4 >= 1)
