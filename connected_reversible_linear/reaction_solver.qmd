...
I am writing the flux vector differently than above to show the concentrations and rate constants explicitly:

$$ \mathbf v(\mathbf x) = \begin{pmatrix} k_1 x_1 \\ k_{-1} x_2 \\ k_2 x_2 \\ k_3 x_3 \\ k_{-3}x_4 \end{pmatrix} $$
...
# Initial concentration conditions and 1000 steps.
