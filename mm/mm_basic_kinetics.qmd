...
# plot(substrate_concentrations, result[:dP_dts], xlabel="[S] (M)", ylabel="d[P]/dt (M/min)", xticks=(xtick_vals, xtick_labels), yticks=(result[:ytick_vals], result[:ytick_labels]), xlims=(0, 1.1e-2))

plot(substrate_concentrations, result[:dP_dts], xlims=(0, 1.1e-2), xlabel="[S] (M)", ylabel="d[P]/dt (M/min)", xticks=(xtick_vals, xtick_labels))
```
